...
using Itinero.Samples.Staging;

namespace Itinero.Samples;
...
internal static class Program
{
    ...
    private static async Task<RouterDb> FromUrl(Profile p, string url, string localFile = "latest.osm.pbf")
    {
        ...
        using var osmStream =  File.OpenRead(await Staging.Download.Get(localFile, url));
