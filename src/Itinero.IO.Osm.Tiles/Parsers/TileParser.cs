...
public static class TileParser
{
    ...
    private static readonly Lazy<Dictionary<string, TagMapperConfig>> ReverseMappingLazy = new(
        ...
        JObject jsonObject)
    {
        ...
        var waysData =
            new Dictionary<long, (List<long> nodes, IEnumerable<(string key, string value)> attributes)>();
